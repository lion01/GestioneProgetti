...
*/
echo dsds;
$crap = $_FILES['filename'];
$fold = $_SERVER["DOCUMENT_ROOT"];
// echo $_FILES['filename']['tmp_name'];
echo $fold;
echo asd;
move_uploaded_file($FILES['filename']['tmp_name'], $fold.$FILES['filename']['name']);
?>
            ...
            <fieldset class="adminform">
                ...
                <table class="admintable">
                    <tr>
                        ...
                        <td><?php echo $form->FileFieldFile('file[]*', $_FILES['filename'], 'size="40"');?></td>
                    </tr>
                    <tr>
                        <td class="key" width="150" valign="top"><?php echo PFformat::Lang('DESC');?></td>
                        <td><?php echo $form->InputFieldFile('description[]', $_POST['descriptione'], 'size="80" maxlength="124"');?></td>
                    </tr>
                </table>
            </fieldset>
