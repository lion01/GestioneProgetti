				...
				<?php if ($s5_responsive_mobile_bar_search == "enabled") { ?>
				  <?php $lang =& JFactory::getLanguage()->load('mod_search');?>
					<form method="post" action="<?php echo JURI::Base()?>">
						<input type="text" onfocus="if (this.value=='<?php echo JText::_("MOD_SEARCH");?>...') this.value='';" onblur="if (this.value=='') this.value='<?php echo JText::_("MOD_SEARCH");?>...';" value="<?php echo JText::_("MOD_SEARCH");?>..." id="s5_responsive_mobile_search" name="searchword"></input>
